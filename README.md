[![Stable Build Status](http://img.shields.io/travis/discordier/justtextwidgets/master.svg?label=stable)](https://travis-ci.org/discordier/justtextwidgets/branches)
